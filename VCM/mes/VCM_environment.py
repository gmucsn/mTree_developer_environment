...
class VCMEnvironment(Environment):
    ...
    def prepare(self):
        self.log_message(f"<E-{self.short_name}> prepare")
        ...
        self.num_conditional_cooperators = self.get_property(
            "num_conditional_cooperators"
        )
    ...
    def set_reminder(self, directive, seconds_to_reminder):
        ...
        self.reminder(seconds_to_reminder=seconds_to_reminder, message=reminder_msg)
    ...
    def start_environment(self, message: Message):
        ...
        self.log_message(f"<E-{self.short_name}> start_environment")
    ...
    def agents_started(self, message: Message):
        ...
        if self.agents_reported == self.num_agents:
            self.send_message(
                "start_period", "VCM_institution.VCMInstitution", self.agent_data
            )
